...
const ABOUT_PAGE_FALLBACK = {
  ...
  story_p1_en: 'Founded in 1994, Nashvell International Trading Co. Ltd. has grown from a regional trading house into a diversified international enterprise. Headquartered in Saudi Arabia with deep roots in Sudan, we connect African products with global markets.',
  story_p1_ar: 'تأسست شركة ناشڤيل للتجارة الدولية المحدودة عام 1994، ونمت من بيت تجاري إقليمي إلى مؤسسة دولية متنوعة الأنشطة. يقع مقرها الرئيسي في المملكة العربية السعودية بجذور عميقة في السودان، ونربط المنتجات الإفريقية بالأسواق العالمية.',
